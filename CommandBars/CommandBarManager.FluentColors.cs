...
public partial class CommandBarManager
{
    ...
    private CommandBarRenderer CreatePreferredRenderer(CommandBarTheme theme)
        => theme == CommandBarTheme.Fluent ? new FluentRenderer(_colorScheme, GetFluentColors()) : theme == CommandBarTheme.Office2000 ? new Office2000Renderer(_colorScheme, _useOffice97Gripper) : theme == CommandBarTheme.OfficeXP ? new OfficeXPRenderer(_colorScheme, _useOfficeXPMultiStripGripper) : ThemeRenderer.Create(theme, _colorScheme);
